 ...
 **/
public class FalseFilterOperator implements FilterOperator {
    @Override
    public String operator() {
        return FilterOperatorDefine.False;
    }
    ...
    public static final FilterOperator instance = new FalseFilterOperator();
}
