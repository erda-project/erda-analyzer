...
import static cloud.erda.analyzer.runtime.expression.functions.operators.FunctionOperatorDefine.equal;

public class EqualFunctionOperator implements FunctionOperator {
    ...
    public boolean invoke(AggregateResult aggregateResult) throws Exception {
        ...
        if (value instanceof Number) {
            ...
            Double result = ConvertUtils.toDouble(aggregateResult.getValue());
            return (d != null && result != null) && d.equals(result);
        }
        return value.equals(aggregateResult.getValue());
    }
}
