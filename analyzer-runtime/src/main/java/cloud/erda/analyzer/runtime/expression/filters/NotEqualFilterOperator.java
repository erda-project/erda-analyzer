 ...
 **/
public class NotEqualFilterOperator implements FilterOperator {

    @Override
    public String operator() {
        return FilterOperatorDefine.NotEqual;
    }
    ...
    public static final FilterOperator instance = new NotEqualFilterOperator();
}
