 ...
 **/
public class NullFilterOperator implements FilterOperator {
    @Override
    public String operator() {
        return FilterOperatorDefine.Null;
    }
    ...
    public static final FilterOperator instance = new NullFilterOperator();
}
