...
/**
 * @author: liuhaoyang
 * @create: 2019-12-18 11:41
 **/
public class InFilterOperator implements FilterOperator {

    @Override
    public String operator() {
        return FilterOperatorDefine.In;
    }
    ...
    public static final FilterOperator instance = new InFilterOperator();
}
