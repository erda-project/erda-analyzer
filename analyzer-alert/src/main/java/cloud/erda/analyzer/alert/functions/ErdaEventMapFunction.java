 ...
 * @author randomnil
 */
public class ErdaEventMapFunction implements MapFunction<RenderedAlertEvent, Event> {

    @Override
    public Event map(RenderedAlertEvent value) throws Exception {
        val metric = value.getMetricEvent();
        val history = new Event();
